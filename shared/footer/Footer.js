    ...
    <footer className="w-full  shadow-[inset_0px_2px_10px_rgba(0,0,0,0.1)]  mx-auto flex flex-col gap-6 md:gap-0 items-center md:flex-row md:items-start text-[#848484] justify-around  bg-white mt-[9.375rem]! md:mt-[7.5rem]! py-6 px-12 pb-12">
      <div className="flex flex-col gap-4 items-center md:items-start">
        ...
        <p className="text-[.9375rem]">
          © Все права <br /> защищены KART
        </p>

        <div className="flex gap-2">
          <Link
            href={"/"}
            className=" flex justify-center items-center rounded-full  w-10 h-10 bg-[#F5F5F5] shadow-2xl"
          >
      ...
      <div className="flex flex-col  text-[.9375rem] md:items-start items-center text-center md:text-start">
        <div className="flex flex-col gap-4 ">
          ...
          <div className="flex flex-col gap-1 items-center md:items-start">
            <div className="flex gap-2 ">
              <MapPinHouse className="w-[1.25rem]" />{" "}
              <p>Сахарова, 11, Рішон Ле-Ціон</p>
            </div>
            <div className="flex gap-2">
              <PhoneIncoming className="w-[1.25rem]" /> <p>+972 54 262 6027</p>
            </div>
            <div className="flex gap-2">
              <CalendarClockIcon className="w-[1.25rem]" />
              <p>Вс-Чт 9:00-17:00</p>
            </div>
          </div>
        </div>
      </div>
